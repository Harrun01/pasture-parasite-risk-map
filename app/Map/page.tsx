      ...
      const handleMapClick = async (e: L.LeafletMouseEvent) => {
        ...
        try {
          ...
          const weatherResponse = await fetch(
            `https://pasture-parasite-risk-map-1.onrender.com/api/weather?lat=${lat}&lon=${lng}`
          );
          ...
          const riskResponse = await fetch(
            `https://pasture-parasite-risk-map-1.onrender.com/api/parasite-risk?lat=${lat}&lon=${lng}&region=${region}`
              );
